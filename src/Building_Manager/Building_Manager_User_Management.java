...
import Admin.Build_Mod_Form;
import Admin.Build_Create_Form;
 ...
 * @author HP
 */
public class Building_Manager_User_Management extends javax.swing.JFrame {

    LoginDetails logindetails;
    /**
     * Creates new form Building_Manager_Sample
     */
    public Building_Manager_User_Management(LoginDetails logindetails1) {
        initComponents();
        AddRowToTable();
...
try (BufferedReader br = new BufferedReader (new FileReader ("Resident.txt"))) {
    ...
    jPanel4Layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
            ...
            .addComponent(searchbox, javax.swing.GroupLayout.PREFERRED_SIZE, 129, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
            .addComponent(search_btn)
            .addGap(18, 18, 18))
        .addGroup(jPanel4Layout.createSequentialGroup()
            .addGap(21, 21, 21)
            .addComponent(TabbedPane, javax.swing.GroupLayout.PREFERRED_SIZE, 607, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    );
    ...
    private void AccCreateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AccCreateBtnActionPerformed
        ...
        Acc_Create_Form acf = new Acc_Create_Form(logindetails);
        acf.setVisible(true);
        dispose();
    ...
    private void AccDeleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AccDeleteBtnActionPerformed
        ...
        int row = Account_Table.getSelectedRow();
        String Id = Account_Table.getModel().getValueAt(row, column).toString();
        Functions.Delete("AccountExecutive.txt", Id);
