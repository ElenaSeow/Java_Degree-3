 ...
 * @author User
 */
public class Acc_Mod_Form extends javax.swing.JFrame {
    LoginDetails logindetails;
    /**
     * Creates new form User_Form
     */

    public Acc_Mod_Form(LoginDetails logindetails1) {
        initComponents();
    ...
    private void SaveBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveBtnActionPerformed
        ...
        Functions.Update("AccountExecutive.txt", id, name,email,password,role,number);
